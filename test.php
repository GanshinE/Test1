...
<body>
    ...
    <div class="hero">
        ...
        <a href="ВАША_ПАРТНЕРСКАЯ_ССЫЛКА_ЗДЕСЬ" class="cta-button">Посмотреть предложения</a>
    </div>
    ...
    <div class="products">
        ...
        <div class="product-grid">
            <div class="product-item">
                ...
                <h3>iPhone 14 Pro</h3>
                <p>Скидка 10%</p>
                <a href="ВАША_ПАРТНЕРСКАЯ_ССЫЛКА_ЗДЕСЬ" class="cta-button">Купить</a>
            </div>
            <div class="product-item">
    ...
    <div class="reviews">
        ...
        <a href="ВАША_ПАРТНЕРСКАЯ_ССЫЛКА_ЗДЕСЬ" class="cta-final">Начать покупки</a>
    </div>
